...
def _format_numero_for_display(val):
    """Formata para exibição na tabela: retorna vazio para ausentes; inteiros sem casas; decimais com ponto.
    Evita mostrar NaN/NAM quando não há valor.
    """
    try:
        ...
        # Em qualquer falha de parsing, mostrar vazio em vez de 'nan' ou texto
        return ""
